...
class SettingsCustomerStep extends StatelessWidget {
  final CustomerFormProvider provider;
  final TextEditingController notesController;
  final bool isEditMode;

  const SettingsCustomerStep({
              ...
              children: [
                Expanded(
                  child: RadioListTile<bool>(
                    ...
                    groupValue: provider.customer.isActive,
                    onChanged: (value) => provider.updateCustomer(
                      provider.customer.copyWith(isActive: value ?? true),
                    ),
                  ),
                ),
                Expanded(
                  child: RadioListTile<bool>(
                    ...
                    groupValue: provider.customer.isActive,
                    onChanged: (value) => provider.updateCustomer(
                      provider.customer.copyWith(isActive: value ?? false),
                    ),
                  ),
                ),
              ],
              ...
              children: [
                Expanded(
                  child: RadioListTile<bool>(
                    ...
                    value: true,
                    activeColor: AppColors.primary, // Couleur primaire fixe
                    groupValue: provider.customer.newsletterSubscribed,
                    onChanged: (value) => provider.updateCustomer(
                      provider.customer.copyWith(newsletterSubscribed: value ?? true),
                    ),
                  ),
                ),
                Expanded(
                  child: RadioListTile<bool>(
                    ...
                    groupValue: provider.customer.newsletterSubscribed,
                    onChanged: (value) => provider.updateCustomer(
                      provider.customer.copyWith(newsletterSubscribed: value ?? false),
                    ),
                  ),
                ),
              ],
        ...
        SectionCard(
          children: [
            ...
            TextField(
              ...
              onChanged: (value) => provider.updateCustomer(
                provider.customer.copyWith(userNotes: value),
              ),
            ),
          ],
        ),
