...
class AddressCustomerStep extends StatelessWidget {
          ...
          return LayoutBuilder(
            builder: (context, constraints) {
              ...
              return SingleChildScrollView(
                child: Column(
                  children: [
                    if (provider.customer.addresses.isEmpty && isEditMode)
                      Padding(
                    ...
                    ...List.generate(provider.customer.addresses.length, (index) {
                      final address = provider.customer.addresses[index];
                      return Column(
                        children: [
                          SectionCard(
                            children: [
                    ...
                    if (isEditMode && provider.customer.addresses.isEmpty)
                      SizedBox(height: 16),
                  ],
                ),
              );
  ...
  Widget _buildMobileAddressFields(BuildContext context,int index, Address address) {
    ...
    return Column(
      children: [
        if (provider.customer.addresses.length > 1 || isEditMode)
          Align(
